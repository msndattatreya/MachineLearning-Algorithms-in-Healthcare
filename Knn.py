...
# Create and train the KNN model for Heart Disease prediction
knn_heart_disease = KNeighborsClassifier(n_neighbors=3)
...
predicted_heart_disease = knn_heart_disease.predict(user_input)
